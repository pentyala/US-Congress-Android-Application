...
public class LegisSideAdapter1 extends ArrayAdapter {
    List<String> data;
    LayoutInflater minflater;
    Context context;
    public LegisSideAdapter1(Context context,List<String> dat) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    int i=0,pos;
                    List<DataItem> dataitems= DataProvider.legdatahouseItemList;
                    ...
                    ((MainActivity)context).moveList(2,i);
                }
            }
        });
